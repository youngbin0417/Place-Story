...
@Composable
fun BrowseUserDiaryPage(navHostController: NavHostController, userId: Long) {
                ...
                (0 until totalPage.value).forEach { page ->
                    Button(
                        ...
                        colors = ButtonDefaults.buttonColors(
                            containerColor = if (page == currentPage) Color.White else colorResource(
                                R.color.letter_daisy),
